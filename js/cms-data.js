...
window.GOZMAR_DEFAULTS = {
    "products": {
        "dms": {
                ...
                "items": [
                    {
                        "icon": "fa-folder-open",
                        "title": "Auto-tagging",
                        "text": "AI-driven auto-tagging and metadata extraction"
                    },
                    {
                        "icon": "fa-shield-halved",
                        "title": "Encryption",
                        "text": "Enterprise-grade encryption and access controls"
                    },
                    {
                        "icon": "fa-magnifying-glass",
                        "title": "Search",
                        "text": "Full-text search across all file types"
                    },
                    {
                        "icon": "fa-clock-rotate-left",
                        "title": "Audit trail",
                        "text": "Version history and audit trails"
                    },
                    {
                        "icon": "fa-file-shield",
                        "title": "Compliance",
                        "text": "Smart retention & compliance policies"
                    },
                    {
                        "icon": "fa-plug",
                        "title": "Integrations",
                        "text": "SSO, Slack & SharePoint integrations"
                    },
                    {
                        "icon": "fa-robot",
                        "title": "Works with you",
                        "text": "Automation that learns your rules and gets better with every file."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "An AI-powered document management system that organises, secures, and retrieves your corporate files with zero friction. Advanced machine learning automatically categorises documents, extracts key data, and enforces compliance — so your team can find anything in seconds."
        },
        "myfamily": {
            "navLabel": "My Family",
                ...
                "items": [
                    {
                        ...
                        "title": "Monitoring",
                        "text": "Real-time home monitoring with smart device integration"
                    },
                    {
                        "icon": "fa-calendar-days",
                        "title": "Shared calendar",
                        "text": "Shared family calendar and chore management"
                    },
                    {
                        "icon": "fa-triangle-exclamation",
                        "title": "Smart alerts",
                        "text": "AI-powered anomaly detection (e.g., unusual entry times)"
                    },
                    {
                        "icon": "fa-lock",
                        "title": "Privacy",
                        "text": "Secure family communication channels"
                    },
                    {
                        "icon": "fa-location-dot",
                        "title": "Geofencing",
                        "text": "Geofenced check-ins for kids & elders"
                    },
                    {
                        "icon": "fa-shield-halved",
                    ...
                    },
                    {
                        ...
                        "text": "One app for parents, kids, and caregivers on every device."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "My Family brings peace of mind to modern households. It combines home supervision, family scheduling, and smart alerts into one beautiful app. AI learns your family’s routines and sends intelligent notifications — from security alerts to reminders for school pickups."
        },
        "freight": {
                ...
                "items": [
                    {
                        "icon": "fa-truck-fast",
                        "title": "Live tracking",
                        "text": "Real-time shipment tracking and predictive ETAs"
                    },
                    {
                        "icon": "fa-file-contract",
                        "title": "Paperwork",
                        "text": "Automated customs and compliance paperwork"
                    },
                    {
                        "icon": "fa-route",
                        "title": "Optimised routes",
                        "text": "Intelligent route optimisation"
                    },
                    {
                        "icon": "fa-users",
                        "title": "Collaboration",
                        "text": "Collaboration hub for shippers, carriers, and clients"
                    },
                    {
                        "icon": "fa-triangle-exclamation",
                        "title": "Predictive alerts",
                        "text": "Predictive delay & disruption alerts"
                    },
                    {
                        "icon": "fa-chart-line",
                        "title": "Insights",
                        "text": "Carbon & cost analytics"
                    },
                    {
                        "icon": "fa-globe",
                        "title": "Global scale",
                        "text": "One control tower for shipments across every region and carrier."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "Gozmar Freight streamlines the entire logistics chain — from booking to delivery. Its AI engine optimises routes, predicts delays, and automates documentation, giving you full visibility and control over every shipment."
        },
        "mylife": {
            "navLabel": "Mylife",
                ...
                "items": [
                    {
                        ...
                        "text": "AI-suggested daily schedules based on your energy levels"
                    },
                    {
                        "icon": "fa-microphone",
                        "title": "Voice capture",
                        "text": "Voice-activated task capture"
                    },
                    {
                        "icon": "fa-book",
                        "title": "Private journal",
                        "text": "Private journal and goal tracking"
                    },
                    {
                        "icon": "fa-sync",
                        "title": "E2E sync",
                        "text": "Cross-device sync with end-to-end encryption"
                    },
                    {
                        "icon": "fa-fire",
                        "title": "Habit tracking",
                        "text": "Habit streaks & gentle nudges"
                    },
                    {
                        "icon": "fa-stopwatch",
                        "title": "Focus mode",
                        "text": "Focus sessions & reminders"
                    },
                    {
                        "icon": "fa-lock",
                        "title": "Private by design",
                        "text": "Your journal, goals, and data stay encrypted and yours alone."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "Mylife is the ultimate AI-powered personal assistant. It learns your habits, prioritises your tasks, and plans your day so you can achieve more with less stress. From meeting notes to personal goals, Mylife keeps everything in one private, secure space."
        },
        "task": {
                ...
                "items": [
                    {
                        ...
                        "title": "Workload AI",
                        "text": "AI-powered workload balancing"
                    },
                    {
                        "icon": "fa-keyboard",
                        "title": "NL task entry",
                    ...
                    },
                    {
                        ...
                        "text": "Kanban, list, and calendar views"
                    },
                    {
                        "icon": "fa-chart-pie",
                        "title": "Analytics",
                    ...
                    },
                    {
                        ...
                        "text": "Bottleneck & slip-risk alerts"
                    },
                    {
                        "icon": "fa-bolt",
                        "title": "Automations",
                        "text": "Automations & templates"
                    },
                    {
                        "icon": "fa-arrows-rotate",
                        "title": "Works with your stack",
                        "text": "Slack, GitHub, and calendar integrations your team already uses."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "Gozmar Task helps teams of any size collaborate effortlessly. Its AI automatically prioritises work, detects bottlenecks, and suggests smarter workflows — so projects move faster and everyone stays aligned."
        },
        "auction": {
                ...
                "items": [
                    {
                        "icon": "fa-gavel",
                        "title": "Live bidding",
                        "text": "Live bidding with sub-second latency"
                    },
                    {
                        "icon": "fa-shield",
                        "title": "Fraud shield",
                        "text": "AI-driven price recommendations and fraud detection"
                    },
                    {
                        "icon": "fa-comments",
                        "title": "Multi-party",
                        "text": "Multi-party collaboration tools (buyers, sellers, agents)"
                    },
                    {
                        "icon": "fa-lock",
                        "title": "Escrow",
                        "text": "Secure escrow and payment integration"
                    },
                    {
                        "icon": "fa-scale-balanced",
                        "title": "Fair-value AI",
                        "text": "Fair-value scoring"
                    },
                    {
                        "icon": "fa-file-signature",
                        "title": "Audit trail",
                        "text": "Full audit trail & reporting"
                    },
                    {
                        "icon": "fa-circle-check",
                        "title": "Confident bids",
                        "text": "Fair-value AI guidance on every lot, every time."
                    }
                ]
            },
            "banners": {
            ...
            "specifications": [],
            "status": "active",
            "shortDescription": "Grey Auction revolutionises online bidding with intelligent automation. It enables real-time auctions, transparent collaboration, and secure transactions — all backed by AI that predicts fair market values and prevents fraud."
        }
    },
    "site": {
        "hero": {
            ...
            "items": [
                {
                    "icon": "fa-brain",
                    "title": "AI-First",
                    "text": "Every product is built around artificial intelligence that learns and adapts to your unique needs."
                },
                {
                    "icon": "fa-shield-alt",
                    "title": "Security by Design",
                    "text": "Enterprise-grade encryption and privacy controls on all platforms, ensuring your data stays yours."
                },
                {
                    "icon": "fa-globe",
                    "title": "Global Reach, Local Touch",
                    "text": "Designed for the world, with deep understanding of diverse markets and cultural contexts."
                },
                {
                    "icon": "fa-magic",
                    "title": "Effortless UX",
                    "text": "Beautiful, intuitive interfaces that require no training — just open and use."
                }
            ]
        },
        "testimonials": {
            "items": [
                {
                    "quote": "Gozmar DMS cut our document retrieval time by 80%. It feels like magic.",
                    "author": "— Sarah O., Operations Director"
                },
                {
                    "quote": "My Family gives me complete peace of mind when I’m away. The AI alerts are spot on.",
                    "author": "— Daniel K., Parent"
                },
                {
                    "quote": "Gozmar Freight transformed our logistics. We now predict delays before they happen.",
                    "author": "— Amara T., Supply Chain Manager"
                }
            ]
        },
        "faq": {
            "items": [
                {
                    "q": "Are Gozmar products available for individual use?",
                    "a": "Yes! Mylife, My Family, and Grey Auction are designed for individual use. Gozmar DMS and Gozmar Task are optimized for teams and enterprises."
                },
                {
                    "q": "Do you offer a free trial?",
                    "a": "We offer 14-day free trials for all products. No credit card required to start."
                },
                {
                    "q": "How is my data protected?",
                    "a": "All products use end-to-end encryption. Data is encrypted at rest and in transit. We never sell your personal data."
                },
                {
                    "q": "What devices do your products support?",
                    "a": "Web access on any modern browser, plus dedicated iOS and Android apps for mobile use."
                }
            ]
        },
        "contact": {
